...
// Sets default values
AParagonImpactEffect::AParagonImpactEffect()
{
	bAutoDestroyWhenFinished = true;
}

void AParagonImpactEffect::PostInitializeComponents()
{
...
UParticleSystem* AParagonImpactEffect::GetImpactFX(TEnumAsByte<EPhysicalSurface> SurfaceType) const
{
	UParticleSystem* ImpactFX = DefaultFX;// NULL;
...
USoundCue* AParagonImpactEffect::GetImpactSound(TEnumAsByte<EPhysicalSurface> SurfaceType) const
{
